...
let songs =[
    ...
    {songName: "Janji-Heroes-Tonight NCS", filePath:"songs/5.mp3" ,coverpath:"Cover/5.jpg"},
...
myprogressBar.addEventListener('change', ()=>{
    audioElement.currentTime = myprogressBar.value * audioElement.duration/100;  // 100 *CT/D = p =>CT = PD/100
})
